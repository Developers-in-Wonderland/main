...
def generate_stabilized_video(cap, x_motion_meshes, y_motion_meshes, new_x_motion_meshes, new_y_motion_meshes):
    ...
    out = cv2.VideoWriter(rf"C:\Users\82109\Desktop\stable.avi", fourcc, frame_rate, (2*frame_width, frame_height))
    ...
    while frame_num < frame_count:
        #try:
            ...
            new_frame = new_frame[HORIZONTAL_BORDER:new_frame.shape[1]-HORIZONTAL_BORDER-1, VERTICAL_BORDER:new_frame.shape[0]-VERTICAL_BORDER-1, :]
...
if __name__ == '__main__':
    ...
    start_time = time.time()
    # get video properties
    file_name = rf"C:\Users\82109\Desktop\output_12.avi"
